...
# 5. 애플리케이션 복사
COPY . .
RUN python -m py_compile teddy_entrypoint.py teddy_network.py teddy_logging.py teddy_generic.py teddy_bootstrap.py teddy_patch_index.py teddy_patch_logs.py && \
...
# 7. Teddy 안정성 + VPN 관리 + 웹 로그 + 범용 yt-dlp 레이어 실행
